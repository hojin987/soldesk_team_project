...
@ToString
@EqualsAndHashCode
public class ApplyBoardPagingDTO {
	private int pageNum;
	private int rowAmountPerPage;
	private String scope; // 검색범위(scope - atitle: T, acontent: C, awriter: W)
	...
	public ApplyBoardPagingDTO(Integer pageNum, Integer rowAmountPerPage) {
