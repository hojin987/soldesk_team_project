            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<form role="form" action="${contextPath}/member/memberRegister" method="post" name="frmBoard">
						...
						<div class="form-group">
							<label>이메일</label> <input class="form-control" name="member_email">
						</div>
						<div class="form-group">
							<label>이름</label> <input class="form-control" name="member_name">
						</div>
						<div class="form-group">
							<label>생년월일</label> <input class="form-control" name="member_birth">
						</div>
						<div class="form-group">
							<label>연락처</label> <input class="form-control" name="member_phonenumber">
						</div>
						<div class="form-group">
							<label>키</label> <input class="form-control" name="member_height">
						</div>
						<div class="form-group">
							<label>몸무게</label> <input class="form-control" name="member_weight">
						</div>
						<div class="form-group">
							<label>골격근량</label> <input class="form-control" name="member_muscle_percent">
						</div>
						<div class="form-group">
							<label>체지방률</label> <input class="form-control" name="member_fat_percent">
						</div>
						<div>
